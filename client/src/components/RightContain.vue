  ...
  <div>
    ...
    <div class="row bg-white">
      ...
      <div class="col-12 bg-img">
        <img class="img-fluid w-100 pl-3 pr-3 pt-3" src="./../assets/wallpaper.webp" alt />
      </div>
      <!-- 头像 -->
      ...
      <div class="col-12 d-flex justify-content-between">
        ...
        <div class="mr-3">
          <a href="https://github.com/raincoded" target="_blanl" class="mr-2">
            <svg height="2rem" viewBox="0 0 16 16" width="1.5rem" aria-hidden="true">
              <path
                fill-rule="evenodd"
      ...
      <div class="col-12 d-flex justify-content-center py-2">
        <div class="d-flex flex-column text-center w-25">
          <span class="border-right border-gray">65</span>
          <span class="border-right border-gray">文章</span>
        </div>
        <div class="d-flex flex-column text-center w-25">
          <span class="border-right border-gray">82343</span>
      ...
      <div class="col-12 px-0">
        ...
        <div class="row mx-0">
          <div class="col-12 ml-2 mt-1" v-for="item in 4" :key="item">
            ...
            <div class="detail p-2 font-weight-light" v-show="item==SuiBiIndex">
              天地不过是飘摇的逆旅，昼夜不过是光阴的门户。——《花镜》人生万千，世事无常。人生是一场短暂的旅程...
              <router-link :to="{name:'Content'}" class="text-decoration-none text-dark">【阅读全文】</router-link>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row bg-white mt-3">
      ...
      <div class="col-12 px-0">
        <ul class="list-group list-group-flush">
          <li class="list-group-item list-group-item-action list-group-item-light py-1" v-for="item in 4" :key="item">
            <router-link
              class="text-decoration-none cursor d-inline-block w-100 text-nowrap text-truncate"
              :to="{name:'Content'}"
            >Cras justo odio</router-link>
          </li>
        </ul>
      </div>
    </div>
