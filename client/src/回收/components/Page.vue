  ...
  <nav aria-label="Page navigation example" v-if="allPage > 2">
    <ul class="pagination justify-content-center">
      <li
        ...
        @click="changePage(1)"
      >
        <span class="page-link" tabindex="-1" aria-disabled="true">首页</span>
      </li>
      <li
        class="page-item"
        :class="{ disabled: curPage == 1 }"
      ...
      >
        <span class="page-link" tabindex="-1" aria-disabled="true">上一页</span>
      </li>
      ...
      >
        <span class="page-link" tabindex="-1" aria-disabled="true">末页</span>
      </li>
    </ul>
  </nav>
</template>
